...
def calculate_percent_change(initial_value, final_value):
    """
    Calculate the percent change between an initial value and a final value.
...
def get_tenders(session):
    return session.get('http://localhost:9999/v1/tenders').json
